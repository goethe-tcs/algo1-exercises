...
Die Abgabe soll wie immer per PDF erfolgen, allerdings sind diesmal ausschließlich mathematische Beweise gefordert. Um einen \emoji{star} zu erhalten, müssen (a) bis (d) zielgerichtet, nachvollziehbar, lesbar, vollständig, und korrekt gelöst sein.
