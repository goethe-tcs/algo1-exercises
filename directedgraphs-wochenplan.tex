	...
	\begin{center}
		\begin{figure}
			...
			\begin{tikzpicture}
				...
				%
				\draw [-stealth, red!50, thick] (n_19) to (n_1);
				\draw [-stealth, red!50, thick] (n_22) to (n_18);
				\draw [-stealth, red!50, thick] (n_16) to (n_8);
				%
				\draw [-stealth, blue!50, thick] (n_11) to (n_21);
				\draw [-stealth, blue!50, thick] (n_9) to (n_17);
				\draw [-stealth, blue!50, thick] (n_4) to (n_13);
				\draw [-stealth, blue!50, thick] (n_14) to (n_24);
			\end{tikzpicture}
			\hspace*{\fill}	
