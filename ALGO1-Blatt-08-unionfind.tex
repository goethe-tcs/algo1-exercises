...
\begin{aufgabe}[Union-Find mit verketteten Listen und Gewichtungen]
	...
	\begin{enumerate}
		...
		\item \note %(\hard) Zeige, dass für die Lösung aus \ref{min} jede Sequenz von $p$ \texttt{Find} und $m$ \texttt{Union} Operationen auf $n$ Elementen eine Laufzeit von $O(p + m\log n)$ hat.
