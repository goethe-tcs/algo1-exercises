...
\begin{aufgabe}[Algorithmen auf verkettete Listen]
	...
	\begin{tikzpicture}
    \node[draw] at (0, 0) (list1-1) {1};
    \node[draw] at (0.5, 0) (list1-2) {\textcolor{white}{0}};
    \node[draw] at (1.5, 0) (list2-1) {2};
    \node[draw] at (2, 0) (list2-2) {\textcolor{white}{0}};
    \draw[->] (list1-2.east) -- (list2-1.west);
    \end{tikzpicture}
