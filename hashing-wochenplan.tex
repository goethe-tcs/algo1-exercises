...
\begin{aufgabe}[Nicht initialisierte Felder, \veryhard]
	...
	Entwirf eine Datenstruktur, die linearen Platz in der Länge des Feldes benötigt, Auslesen und Ändern in konstanter Zeit pro Eintrag unterstützt und nur konstante Zeit für die Initialisierung benötigt.
\end{aufgabe}
