...
\begin{aufgabe}[Dynamische Zusammenhangskomponente und Suche in Graphen]\mbox{}\\
	...
	Entwirf einen einfache Implementierung der abstrakten Datenstruktur für den dynamischen Zusammenhang (mit den Operationen \textsc{Init}, \textsc{Connectected}, \textsc{Insert}) mittels Suche in Graphen und vergleiche die Komplexität deiner Lösung mit der auf Union-Find basierenden Lösungen.
\end{aufgabe}
\newpage
\section*{Freitag}
