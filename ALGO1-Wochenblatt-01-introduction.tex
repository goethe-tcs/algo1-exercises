...
\item[\schriftlich] Schriftliche Aufgabe, die Abgabe erfolgt in Moodle.
\item[\bestehen] Diese Art von Aufgabe muss man sicher können, um die Klausur zu bestehen.
\item[\mittel] Diese Art von Aufgabe muss man weitgehend können, um die Klausur zu bestehen.
\item[\note] Diese Art von Aufgabe muss man können, um eine gute Note zu erhalten.
